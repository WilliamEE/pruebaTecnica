            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PersonId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PersonFullName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    PersonAddress = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
